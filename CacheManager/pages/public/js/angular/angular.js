 ...
 * @description
 *
 * `$sce` is a service that provides Strict Contextual Escaping service to AngularJS.
 *
...
function badInputChecker(scope, element, attr, ctrl) {
  ...
  if (nativeValidation) {
    ctrl.$parsers.push(function(value) {
      ...
      // - see http://www.whatwg.org/specs/web-apps/current-work/multipage/forms.html#e-message-state-(type=email)
 ...
 * service for data-binding, validation, CSS updates, and value formatting and parsing. It
 ...
 * @example
  <example>
    <file name="index.html">
      ...
      <a ng-click="currentTpl='/views.html'" id="views-link">Load inlined template</a>
      <div id="views-content" ng-include src="currentTpl"></div>
    </file>
    <file name="protractor.js" type="protractor">
      it('should load template defined inside script tag', function() {
        element(by.css('#views-link')).click();
        expect(element(by.css('#views-content')).getText()).toMatch(/Content of the template/);
      });
    </file>
  </example>
 */
